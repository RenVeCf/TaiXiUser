...
public class NoticeView extends ViewFlipper implements View.OnClickListener {
    ...
    private List<HomeBean.HeadlineBean> mNotices;
     ...
     * @param notices
     */
    public void addNotice(List<HomeBean.HeadlineBean> notices) {
        mNotices = notices;
        removeAllViews();
        for (int i = 0; i < mNotices.size(); i++) {
            // 根据公告内容构建一个TextView
            HomeBean.HeadlineBean notice = notices.get(i);
    ...
    public void onClick(View v) {
        ...
        HomeBean.HeadlineBean notice = mNotices.get(position);
    ...
    public interface OnNoticeClickListener {
        void onNotieClick(int position, HomeBean.HeadlineBean notice);
    }
