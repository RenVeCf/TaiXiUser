...
import com.ipd.taixiuser.ui.fragment.manage.MoveStockFragment

class MoveStockActivity : BaseUIActivity() {
    companion object {
    ...
    override fun loadData() {
        supportFragmentManager.beginTransaction().replace(R.id.fl_container, MoveStockFragment()).commit()
    }
